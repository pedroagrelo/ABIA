...
{   
    ...
    {   
        ...
        while (continuar)
        {
            ...
            Solucion? solucionFinal = algoritmoAEstrella.Busqueda(new Solucion(solucionInicial), CriterioParada, ObtenerVecinos, CalculoCoste, out revisados,CalculoHeuristica ); // antes qwue calculo heuristica 
