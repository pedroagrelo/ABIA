...
class Program
{
    ...
    {   
        ...
        while (continuar)
        {
            ...
            Solucion? solucionFinal = algoritmoAEstrella.Busqueda(new Solucion(solucionInicial), CriterioParada, ObtenerVecinos, CalculoCoste,out revisados, CalculoHeuristica);
            
            /*//Inicio de Búsqueda en Profundidad
            BusquedaEnProfundidad busquedaEnProfundidad = new BusquedaEnProfundidad();
            Solucion? solucionFinal = busquedaEnProfundidad.Busqueda(new Solucion(solucionInicial), CriterioParada, ObtenerVecinos, CalculoCoste);
    */
